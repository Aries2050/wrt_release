...
BUNDLE_DIR="$BUILD_DIR/package/base-files/files/$GLIBC_DIR"
WRAPPER_PATH="$BUILD_DIR/package/base-files/files/usr/bin/glibc-run"
INIT_SCRIPT_PATH="$BUILD_DIR/package/base-files/files/etc/init.d/glibc-compat"
