...
| 2026-08-03 | `feat/add-usb-wifi-drivers` | 新增 USB WiFi 驱动：RTL8812BU（`kmod-rtl88x2bu-morrownr`，morrownr/88x2bu-20210702） |
...
| `kmod-rtl88x2bu-morrownr` | `feat/add-usb-wifi-drivers` | RTL8812BU/RTL8822BU USB 无线网卡驱动（morrownr/88x2bu-20210702，支持 Alfa AWUS036ACH、Edimax EW-7822UTC 等） |
